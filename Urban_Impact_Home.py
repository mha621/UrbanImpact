...
# Open the image file
img = Image.open(r'C:\Users\Michelle\Downloads\UrbanImpact\pages\images\Urban_Impact_Logo_3.png')
...
def feature_1():
    ...
    st.image(r'C:\Users\Michelle\Downloads\UrbanImpact\pages\images\feat_1_ss.png')

def feature_2():
    st.markdown('<div class="sub-header">Envision Your Ideal City</div>', unsafe_allow_html=True)
    st.image(r'C:\Users\Michelle\Downloads\UrbanImpact\pages\images\feat_2_ss.png')

def feature_3():
    st.markdown('<div class="sub-header">Stay Updated with the Latest News</div>', unsafe_allow_html=True)
    st.image(r'C:\Users\Michelle\Downloads\UrbanImpact\pages\images\feat_3_ss.png')
